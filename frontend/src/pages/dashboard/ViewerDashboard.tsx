...
import { BookSize } from '../../types'; // Ensure this is correctly defined/imported
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        <Button
          variant="outline"
          size="sm"
          onClick={handleRefresh} // Use handleRefresh instead of handleDataRefresh for consistency
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center mb-2">
                        <div className="relative">
                          <img
                            src={personalStats.topSellerBook.image_url || 'https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg'}
                      ...
                      <p className="mt-1 text-lg font-bold text-purple-600 truncate max-w-full" title={personalStats.topSellerBook.title}>
