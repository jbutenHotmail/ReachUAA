      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <div className="text-center">
            ...
            <p className="text-xs text-gray-500">{t('dashboard.bookBreakdown', { large: dayTotals.largeBooks, small: dayTotals.smallBooks })}</p>
          </div>
        </Card>
                  ...
                  {dayTransactions.map((transaction) => (
                    <div key={transaction.id} className="p-4 bg-gray-50 rounded-lg">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          <p className="font-medium text-gray-900">{t('common.leader')}: {transaction.leaderName}</p>
                  ...
                  <div className="pt-3 border-t border-gray-200">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center gap-3">
                        <Badge variant="primary">{t('inventory.size.large')} {dayTotals.largeBooks}</Badge>
                        <Badge variant="success">{t('inventory.size.small')} {dayTotals.smallBooks}</Badge>
                        <Badge variant="secondary" size="lg">{t('common.total')} {dayTotals.books}</Badge>
                      </div>
                    </div>
                  </div>
                </div>
